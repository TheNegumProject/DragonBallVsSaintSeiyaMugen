...
;*****************************************************************************************
;                                                                                        *                               *
;Seiya de Pegasus V3 Autor  Grafica : Arsene Lupin (base general de sprit                *
;                                    Claudio Ricci(MIM) , David Bazbar y Tecla2000)      *                   *
...
;Meteoros de Pagaso, Aereo (Pegasus ryuseiken air) (aire)
[Command]
...
;Meteoros de Pagaso dorado (Golden Pegasus ryuseiken Ken)
[Command]
name = "ryuseiken_golden"
...
;Golpe desesperado Seika
[Command]
name = "combo_desesperado"
command = F, DF, D, DB, B, z
time = 35
...
;Golpe Armadura Divina
[Command]
name = "armadura_divina"
command = F, DF, D, DB, B, c
time = 35
...
type = ChangeState
value = 3900
triggerall = command = "ryuseiken_golden"
triggerall = power >= 3000
triggerall = statetype != A
triggerall = (stateNo != [1920,1932])
trigger1 = statetype != A
...
type = ChangeState
value = 3800
triggerall = command = "combo_desesperado"
triggerall = power >= 3000
triggerall = p2statetype != L
triggerall = life <= 250
triggerall = statetype != A
...
type = ChangeState
value = 4000
triggerall = command = "armadura_divina"
triggerall = power >= 3000
triggerall = p2statetype != L
